<template>
  <form action="" class="relative" @submit.prevent="updatePreferencesData">
    ...
    >
      ...
      <BaseInputGroup
          :label="$tc('settings.preferences.attendance_system')"
          :content-loading="isFetchingInitialData"
          required
        >
          <BaseMultiselect
            v-model="settingsForm.attendance_system"
            :content-loading="isFetchingInitialData"
            :options="globalStore.config.attendance_system"
            label="name"
            value-prop="name"
            track-by="name"
            :searchable="true"
      ...
      <BaseInputGroup
          :label="$tc('settings.preferences.health_care_system')"
          :content-loading="isFetchingInitialData"
          required
        >
          <BaseMultiselect
            v-model="settingsForm.health_care_system"
            :content-loading="isFetchingInitialData"
            :options="globalStore.config.health_care_system"
            openDirection="top"
            label="name"
            value-prop="name"
            track-by="name"
