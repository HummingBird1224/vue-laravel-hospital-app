  ...
  props: {
    ...
    classes: {
      ...
      default: () => ({
        ...
        dropdown:
          'max-h-44 shadow-lg absolute -left-px -right-px -bottom-1 translate-y-full border border-gray-300 mt-1 overflow-y-auto z-50 bg-white flex flex-col rounded-md',
        dropdownTop:
