...
Route::get('test2', function(){
    ...
    $pcc = new \App\Services\PointClickCare();
...
Route::get('test',function(){
    $x = array_search('Bihar', array_column(config('App.states'), 'name') );
    dd(config('App.states')[$x]['code']);
});
...
})->where('vue', '[\/\w\.-]*')->name('customer.dashboard');
