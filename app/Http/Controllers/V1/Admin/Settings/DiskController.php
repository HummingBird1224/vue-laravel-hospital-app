...
//         $cred = ["bucket" => "pegatest12",
// "key" => "AKIA5JKR33T2465E6IM4",
// "name" => "s3bkt",
// "region" => "ap-south-1",
// "root" => "/s3pega/",
// "secret" => "hiuYwmI4FNOGZt0xNnpq9+tMrIBeI/MVwsFas3MN",
// "selected_driver" => "s3"];

//         dd(FileDisk::validateCredentials( $cred, "s3"));
...
"name" => "dropbox",
"root" => "karobar",
"secret" => "d28hld6h7rok8wv",
"token" => "sl.BJou5xUP05j5AbVAQbJLoW-tdIwVU5w6kY8LmM8ToPWWAq5ptlOWT_azFUDjuLSCypyOUW2LgQHSPcAp5hAkfdGpH00WlTobbnC2qo9U4NKPtQsFZp_RYTXrITNb9Z9GBiYBtV9Gblqy",

"selected_driver" => "dropbox"
];

        dd(FileDisk::validateCredentials( $cred, "dropbox"));
